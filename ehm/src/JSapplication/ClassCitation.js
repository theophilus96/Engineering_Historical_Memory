...
export class Citation {
    ...
    createCitationList() {
        ...
        this.citations = {
            sinai: {item_authors: ["Nanetti, A."], authors: ["Nanetti, A.", "Vu, N. K."], year: "June 2020", item_year: "2020"},
            ...
            cm: {item_authors: ["Nanetti, A."], authors: ["Nanetti, A.", "Vu, N. K."], year: "Dec 2019", item_year: "2020"},
            mp: {
            ...
            mc: {item_authors: ["Nanetti, A."], authors: ["Nanetti, A.", "Vu, N. K."], year: "2018", item_year: "2018"},
            fm: {
                item_authors: ["Nanetti, A.", "Falchetta, P."],
                authors: ["Nanetti, A.", "Falchetta, P.", "Liu, DY.", "Vu, N. K."],
                year: "Nov 2019", item_year: "2019"
            },
            fm_v: {
                item_authors: ["Wibowo, A. H.", "Benvenuti, D.", "Nanetti, A."],
                authors: ["Nanetti, A.", "Falchetta, P.", "Liu, DY.", "Vu, N. K."],
            ...
            fgm: {item_authors: ["Nanetti, A."], authors: ["Nanetti, A.", "Vu, N. K."], year: "Oct 2020", item_year: "2020"},
            vis: {item_authors: ["Liu, DY."], authors: ["Liu, DY.", "Nanetti, A.", "Vu, N. K."], year: "Nov 2020", item_year: "2020"},
            ayu: {
    ...
    getCitation(format) {
        ...
        if (this.map_type in this.citations) {
            ...
            if (format === 'apa') {
                if (this.isItem) return `${item_authors} (${item_year})${this.title}. In ${authors} (Eds.). <i>EHM – ${this.page_name}</i>. Retrieved from <a href="${window.location.href}">${window.location.href}</a> (accessed on ${formatted_date})`;
