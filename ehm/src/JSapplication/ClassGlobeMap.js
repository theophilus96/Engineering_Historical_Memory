...
export class GlobeMap {
    constructor(container, mapType, totalResults, clickAction, searchAction, changeModeAction, currentMode, maxClusterLayer, initialLayer, initialCenter, currentVis) {
    ...
    initMap() {
        ...
        this.visSelect.addEventListener('change', () => this.changeToVis(this.visSelect.value));
