      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="d-flex mb-5">
            ...
            <p class="text-gray-800 mb-9 mb-md-11">
          ...
          <div class="row">
            ...
            <div class="d-flex">
              <ul class="mb-0">
                ...
                <li class="text-gray-800 mt-4">History teachers</li>
                <li class="text-gray-800 mt-4">Librarians</li>
                <li class="text-gray-800 mt-4">Archivists</li>
                <li class="text-gray-800 mt-4">Museum curators</li>
                <li class="text-gray-800 mt-4 mb-6 mb-md-8">General public</li>
              </ul>
            </div>
            ...
            <h3 class="mb-5">Methodological foci</h3>
            <div class="d-flex">
              <ol class="mb-0">
                <li class="text-gray-800">
            ...
            <h3 class="mb-5">Spaces of fruition</h3>
            <p class="fs-lg text-gray-800 mb-5">
