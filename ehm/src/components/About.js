      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md">
            <h1 class="display-4 mb-2">About</h1>

            <p class="fs-lg text-gray-700 mb-md-0">Updated 31/5/2021</p>
          </div>
          <div class="col-auto">
        ...
        <div class="row">
          <div class="col-12 col-md-8">
            ...
            <h3 class="mb-5">Licensing Terms</h3>
            ...
            <div class="d-flex">
              ...
              <p class="text-gray-800">
                ...
                adhering to the original license or clearing it with the author
                of the code, image, or content.
              </p>
            </div>
            <div class="d-flex">
              <span class="badge badge-rounded-circle bg-success-soft mt-1 me-4">
              ...
              <p class="text-gray-800">
                This license can be terminated if you breach it and you lose the
                right to distribute the End Product until the Theme has been
                fully removed from the End Product.
              </p>
            </div>
            <div class="d-flex">
              <span class="badge badge-rounded-circle bg-success-soft mt-1 me-4">
              ...
              <p class="text-gray-800">
                ...
                Themes) are not a party to this license or the one granting you
                the license.
              </p>
            </div>
            ...
            <h3 class="mb-5">Additional Terms</h3>
            ...
            <div class="d-flex">
              ...
              <p class="text-gray-800">
                ...
                Bootstrap Themes does not directly process payments through the
                website.
              </p>
            </div>
            <div class="d-flex">
            ...
            <div class="d-flex">
              ...
              <p class="text-gray-800 mb-6 mb-md-0">
                ...
                policies. We may at any time suspend or terminate your account.
              </p>
            </div>
          </div>
